...
int main(int argc, char *argv[])
{
  ...
  16:	e8 af 03 00 00       	call   3ca <uptime>
  1b:	89 c6                	mov    %eax,%esi
    int pid = fork();
  1d:	e8 08 03 00 00       	call   32a <fork>

    if (!pid)
  22:	85 c0                	test   %eax,%eax
  24:	75 1a                	jne    40 <main+0x40>
    { //child
        int exec_ret = exec(argv[one], &argv[one]);
  26:	8d 43 04             	lea    0x4(%ebx),%eax
  29:	56                   	push   %esi
  2a:	56                   	push   %esi
  2b:	50                   	push   %eax
  2c:	ff 73 04             	pushl  0x4(%ebx)
  2f:	e8 36 03 00 00       	call   36a <exec>
        //suppress complaints for null execution
        if (exec_ret < zero && argv[one])
  34:	83 c4 10             	add    $0x10,%esp
  37:	85 c0                	test   %eax,%eax
  39:	78 25                	js     60 <main+0x60>
    ...
    exit();
  3b:	e8 f2 02 00 00       	call   332 <exit>
            exit();
        }
    }
    else
  ...
  47:	78 31                	js     7a <main+0x7a>
            printnum(argv[one], uptime() - start_time);
  49:	e8 7c 03 00 00       	call   3ca <uptime>
  4e:	29 f0                	sub    %esi,%eax
  50:	52                   	push   %edx
  51:	52                   	push   %edx
  52:	50                   	push   %eax
  53:	ff 73 04             	pushl  0x4(%ebx)
  56:	e8 35 00 00 00       	call   90 <printnum>
  5b:	83 c4 10             	add    $0x10,%esp
  5e:	eb db                	jmp    3b <main+0x3b>
  ...
  65:	74 d4                	je     3b <main+0x3b>
        {
            printf(2, "execution of %s failed\n", argv[1]);
  67:	51                   	push   %ecx
  68:	50                   	push   %eax
  69:	68 e3 07 00 00       	push   $0x7e3
  6e:	6a 02                	push   $0x2
  70:	e8 1b 04 00 00       	call   490 <printf>
            exit();
  75:	e8 b8 02 00 00       	call   332 <exit>
    {
        int wait_ret = wait();
        if (wait_ret >= zero)
            printnum(argv[one], uptime() - start_time);
            ...
            printf(2, "Error: %s could not be executed", argv[one]);
  7a:	50                   	push   %eax
  7b:	ff 73 04             	pushl  0x4(%ebx)
  7e:	68 fc 07 00 00       	push   $0x7fc
  83:	6a 02                	push   $0x2
  85:	e8 06 04 00 00       	call   490 <printf>
  8a:	83 c4 10             	add    $0x10,%esp
  8d:	eb ac                	jmp    3b <main+0x3b>
  8f:	90                   	nop
...
void printnum(const char *cmd, const uint time)
{
  ...
  a4:	c1 e8 05             	shr    $0x5,%eax
  a7:	6b c0 64             	imul   $0x64,%eax,%eax
  aa:	29 c1                	sub    %eax,%ecx
  ac:	83 f9 09             	cmp    $0x9,%ecx
  af:	74 1f                	je     d0 <printnum+0x40>
        printf(2, "%s ran in %d.%d seconds\n", cmd, time / 100, time % 100);
  b1:	83 ec 0c             	sub    $0xc,%esp
  b4:	c1 ea 05             	shr    $0x5,%edx
  b7:	51                   	push   %ecx
  b8:	52                   	push   %edx
  b9:	ff 75 08             	pushl  0x8(%ebp)
  bc:	68 b0 07 00 00       	push   $0x7b0
  c1:	6a 02                	push   $0x2
  c3:	e8 c8 03 00 00       	call   490 <printf>
...
void printnum(const char *cmd, const uint time)
{
  ...
  d3:	c1 ea 05             	shr    $0x5,%edx
  d6:	6a 09                	push   $0x9
  d8:	52                   	push   %edx
  d9:	ff 75 08             	pushl  0x8(%ebp)
  dc:	68 c9 07 00 00       	push   $0x7c9
  e1:	6a 02                	push   $0x2
  e3:	e8 a8 03 00 00       	call   490 <printf>
...
putc(int fd, char c)
{
 ...
 62b:	b8 28 00 00 00       	mov    $0x28,%eax
        ...
        if(s == 0)
          s = "(null)";
 630:	bb 1c 08 00 00       	mov    $0x81c,%ebx
...
free(void *ap)
{
 ...
 697:	89 08                	mov    %ecx,(%eax)
  freep = p;
 699:	a3 ec 0a 00 00       	mov    %eax,0xaec
}
 69e:	5b                   	pop    %ebx
 69f:	5e                   	pop    %esi
 6a0:	5f                   	pop    %edi
 ...
 6ba:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6bd:	a3 ec 0a 00 00       	mov    %eax,0xaec
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 15 ec 0a 00 00    	mov    0xaec,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 71f:	76 3f                	jbe    760 <malloc+0x90>
    ...
    if(p == freep)
 721:	39 05 ec 0a 00 00    	cmp    %eax,0xaec
 ...
 746:	e8 f5 fe ff ff       	call   640 <free>
  return freep;
 74b:	8b 15 ec 0a 00 00    	mov    0xaec,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 76c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 76f:	89 15 ec 0a 00 00    	mov    %edx,0xaec
      return (void*)(p + 1);
 ...
 784:	eb e9                	jmp    76f <malloc+0x9f>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 786:	c7 05 ec 0a 00 00 f0 	movl   $0xaf0,0xaec
 78d:	0a 00 00 
 790:	c7 05 f0 0a 00 00 f0 	movl   $0xaf0,0xaf0
 797:	0a 00 00 
    base.s.size = 0;
 79a:	b8 f0 0a 00 00       	mov    $0xaf0,%eax
 79f:	c7 05 f4 0a 00 00 00 	movl   $0x0,0xaf4
 7a6:	00 00 00 
